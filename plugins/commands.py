...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton('💝 MEGA CHANNEL', url='https://t.me/NaughtyX11')
            ],[
            InlineKeyboardButton('🔍 Premium Content', url='https://t.me/+g6nTSnQ6L9kxYjU1'),
            InlineKeyboardButton('🤖 Backup', url='https://t.me/NaughtyXBackup')
            ],[
